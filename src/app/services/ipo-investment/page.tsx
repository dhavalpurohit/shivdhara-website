...
export const metadata: Metadata = constructMetadata({
  ...
  description:
    "Apply for IPO investments with expert assistance from Shivdhara Securities. Learn about upcoming IPOs and invest with confidence.",
});
      ...
      <Container className="relative z-10">
        <div className="max-w-3xl space-y-6">
          ...
          <p className="text-xl text-blue-100/90 leading-relaxed">
            Invest early in promising companies and unlock new wealth creation
            opportunities with our expert guidance and seamless application
            process.
          </p>
