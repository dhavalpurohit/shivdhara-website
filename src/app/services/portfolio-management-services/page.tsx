...
export const metadata: Metadata = constructMetadata({
  ...
  description: "Discover personalized Portfolio Management Services (PMS) at Shivdhara Securities. Build customized investment strategies with expert portfolio management.",
});
      ...
      <Container className="relative z-10">
        <div className="max-w-3xl space-y-6">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white tracking-tight">
            Portfolio Management <span className="text-secondary">Services</span>
          </h1>
          <p className="text-xl text-blue-100/90 leading-relaxed">
            Highly personalized investment strategies designed exclusively to help grow, protect, and preserve your wealth across generations.
          </p>
