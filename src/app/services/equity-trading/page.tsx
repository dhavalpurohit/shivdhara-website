...
export const metadata: Metadata = constructMetadata({
  ...
  description: "Trade confidently in the stock market with expert guidance, professional research, and reliable execution support from Shivdhara Securities.",
});
      ...
      <Container className="relative z-10">
        <div className="max-w-2xl space-y-6">
          ...
          <p className="text-xl text-blue-100/90 leading-relaxed">
            Trade confidently in the stock market with expert guidance and reliable execution support tailored for your financial success.
          </p>
